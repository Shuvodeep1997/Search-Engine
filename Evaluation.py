...
def get_rank_from_gold_standard(top20docs):
    gold_std_file=open('rankedRelevantDocList.csv')
...
query_doc_file=open('PAT2_07_ranked_list_A.csv')
...
for element in id_list:
    ...
    #ndcg_10[element] = calc_ndcg(top20docs_new, 20)
...
with open('evalution_out.csv', 'w') as csv_file:
