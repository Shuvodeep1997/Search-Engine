...
def cal_avg_non_rel_list(doc_tfidfscheme1,non_rel_doc,gamma,res_rel):
    ...
    for key,value in non_rel_doc.items():
        ...
        if(len_rel>0):
            ...
            print("gamma value:"+str(beta_cal))
            for i in range(0,len(value)):
                for key1,value1 in doc_tfidfscheme1.items():
                    for key2,value2 in value1.items(): 
                        print("key value"+str(key1))
                        print("next key value"+str(value[i]))
                        print("terms are "+len(str(key2)))
                        if(str(key1)==str(value[i]) and (len(str(key2)))>0):
                            temp[key2]=temp[key2]+value2
                            print("temp value"+str(temp[key2]))
            for key4 in temp.keys():
                temp[key4]=temp[key4]*beta_cal
...
# print("fin_query_tfidf_1")
# for key,value in fin_query_tfidf_1.items():
#     for key1,value1 in value.items():
#         if(value1!=0.0):
#             print(value1)
# print("--------")
# print("fin_query_tfidf_2")
# for key,value in fin_query_tfidf_2.items():
#     for key1,value1 in value.items():
#         if(value1!=0.0):
#             print(value1)
...
s=0
print("rel-doc-1")
for key,value in rel_doc_avg_1.items():
    for key1,value1 in value.items():
        s+=float(value1)
print(s)
s=0
print("--------")
print("rel-doc-2")
for key,value in rel_doc_avg_2.items():
    for key1,value1 in value.items():
        s+=float(value1)
print(s)
...
s=0
print("non_rel-doc-1")
for key,value in non_rel_doc_avg_1.items():
    for key1,value1 in value.items():
        s+=float(value1)
print(s)
s=0
print("--------")
print("non_rel-doc-2")
for key,value in non_rel_doc_avg_2.items():
    for key1,value1 in value.items():
        s+=float(value1)
print(s)
...
with open('PAT2_07_rochio_new_A.csv', 'w') as csv_file:
...
with open('PAT2_07_PSRF_rochio_new_A.csv', 'w') as csv_file1:
